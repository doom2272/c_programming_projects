...
//adds price to the part structure,
//insert asks user for the price of a new item,
//search and print display the price
//add a new command to the switch statement in main used to edit the price of a part.
...
/*****************************************************************************
 * update_price: allows user to change the price of a part                   *
 *****************************************************************************/
void update_price(void)
{
  int i, number;
  ...
  if (i >= 0) {
    printf("Enter new price for part number %d: ", number);
    scanf("%f", &new_price);
